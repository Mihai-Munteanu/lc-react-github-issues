...
function App() {
     ...
     const { isSuccess: isSuccessIssueOpen, data: issuesOpen } = useQuery(
          "issuesOpen",
          fetchIssuesOpen
     );
     const { isSuccess: isSuccessIssueClosed, data: issuesClosed } = useQuery(
          "issuesClosed",
          fetchIssuesClosed
     );
